...
// <<<<<<< HEAD
void calculate_vs_relate_to_params(Particle& p_current, Particle& p_relate_to, double& l, double* quat)
// =======
...
// >>>>>>> ae7eaec6442fa8656e429169f48afd38a9863551
{
  // <<<<<<< HEAD
...
int vs_relate_to(int part_num, int relate_to)
{
  ...
  // merge hack
  //if ((get_particle_data(relate_to,&p_relate_to)!=ES_OK) || (get_particle_data(part_num,&p_current)!=ES_OK)) {
  if ((get_particle_data(relate_to)!=ES_OK) || (get_particle_data(part_num)!=ES_OK)) {
