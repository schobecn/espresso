...
\begin{essyntax}
\variant{1} bond\_breakage add \var{name} \var{name} ...
\variant{2} bond\_breakage list
\variant{3} bond\_breakage clear
\end{essyntax}


\begin{pysyntax}
  \object{
    system.non_bonded_inter.bond_breakage
  }{
    add_handler
  }{ (\var{name})
  }
